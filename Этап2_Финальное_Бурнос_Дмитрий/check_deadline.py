...
from Check_deadline_bonus2 import check_issue_date


def inp():# вывод даты в обратной последовательности(День - Месяц - Год)
...
issue_date=check_date(check_issue_date)
