...
def check_date():
    ...
    while issue_date==0:
        try:
            issue_date=date(int(check_issue_date2[6:11]),int(check_issue_date2[3:5]),int(check_issue_date2[0:2]))
        except ValueError:
            try:
                issue_date=date(int(check_issue_date2[0:4]),int(check_issue_date2[5:7]),int(check_issue_date2[8:10]))
            except ValueError:
